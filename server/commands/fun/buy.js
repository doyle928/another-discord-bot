                          ...
                          if (
                            ...
                            try {
                              ...
                              for (let i in res.getSchedules) {
                                if (
                                  res.getSchedules[i].message ===
                                  `roleremove ${role.id}`
                                ) {
                                  let date = new Date(
                                    res.getSchedules[i].date
                                  );
                            ...
                            message.channel
                              .send(
                                `so you want to by a new 1 month role for 10.000 !\nwhat do you want the name of it to be ??`
                              )
                              .then(() => {
                                message.channel
                                  .awaitMessages(
